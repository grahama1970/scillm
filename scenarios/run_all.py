...
SCENARIOS: List[Tuple[str, List[str]]] = [
    ...
    ("certainly_bridge_release.py", [PYTHON, str(SCENARIO_DIR / "certainly_bridge_release.py")]),
    ("certainly_router_release.py", [PYTHON, str(SCENARIO_DIR / "certainly_router_release.py")]),
