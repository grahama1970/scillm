"""Minimal JSON helpers for SciLLM extras.

This is the canonical implementation used by downstream projects. It mirrors the
LiteLLM helpers so callers can depend on a stable `scillm.extras.json_utils` path.
"""
